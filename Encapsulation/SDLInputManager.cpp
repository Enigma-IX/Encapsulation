	...
	while (SDL_PollEvent(&event))
	{
		...
		if (event.type == SDL_KEYDOWN || event.type == SDL_KEYUP)
		{
			...
			switch (event.key.keysym.sym) {
				...
				// User 2
				case SDLK_z: user2Keys[0] = isPressed; break;     // Z
				case SDLK_s: user2Keys[1] = isPressed; break;     // S
				case SDLK_q: user2Keys[2] = isPressed; break;     // Q
				case SDLK_d: user2Keys[3] = isPressed; break;     // D
		}
	}
}
